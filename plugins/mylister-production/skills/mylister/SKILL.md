...
Use this plugin's MyLister MCP tools. This package targets **production** at
`https://mcp.mylister.dev/mcp`, backed by `https://api.mylister.dev/v1`.
Do not silently switch to staging, the standalone API-key skill, or another account.
